...
import com.example.smartgymapp.databinding.FragmentDoctorsBookedBinding
...
@AndroidEntryPoint
class DoctorsBookedFragment : Fragment() {
    private lateinit var binding: FragmentDoctorsBookedBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDoctorsBookedBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun observeTrainers() {
        ...
        chatViewModel.getTrainersFromBookedAccepted("Doctor")
    }
